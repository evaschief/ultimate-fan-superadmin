...
const fieldLabels: Record<string, string> = {
  period: 'period', clock_seconds: 'clock', home_score: 'home score', away_score: 'away score', score_difference: 'score difference', score_difference_abs: 'score gap', is_tied: 'game tied', offense_team: 'offense', offense_is_trailing: 'offense trailing', is_new_drive: 'new drive', down: 'down', yards_to_go: 'yards to go', field_position_yards: 'yards to end zone', is_red_zone: 'in the red zone', drive_play_count: 'drive play count', play_type_slug: 'play type', drive_end_scored: 'drive scored', drive_end_touchdown: 'drive touchdown', drive_end_turnover: 'drive turnover', featured_player_id: 'featured player ID', featured_player_name: 'featured player', featured_player_position: 'featured player position', featured_player_passing_yards: 'featured player passing yards', featured_player_rushing_yards: 'featured player rushing yards', featured_player_receiving_yards: 'featured player receiving yards', featured_player_rush_attempts: 'featured player rushing attempts', featured_player_touchdown_count: 'featured player touchdowns',
};
